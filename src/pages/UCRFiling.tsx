      ...
      <div className="max-w-4xl mx-auto space-y-16">
        ...
        <section className="space-y-12 bg-[#edf7ff] p-8 rounded-xl shadow-sm">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed pl-3 pr-3">
          ...
          <div>
            ...
            <ul className="list-disc pl-6 pr-3 text-gray-600 space-y-3">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4 pl-3 pr-3">The UCR program operates under:</p>
            <ul className="list-disc pl-6 pr-3 text-gray-600 space-y-3">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6 pl-3 pr-3">Currently, 41 U.S. states participate in the UCR program</p>
            <p className="font-semibold mb-4 pl-3 pr-3">Non-participating states:</p>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6 pl-3 pr-3">
            ...
            <p className="text-gray-600 italic bg-gray-50 p-4 rounded-lg pl-3 pr-3">
